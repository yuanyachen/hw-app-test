...
if du.driver.is_app_installed('com.hanweiyx.hanwei'):
    try:
        ...
        if seek_ret1['status']:
            ...
            print('下单前%s  下单后%s' % (order_front3, order_behind3))
        ...
        if seek_ret['status']:
            ...
            print('下单前%s  下单后%s' % (order_front, order_behind))
        ...
        print('下单前%s  下单后%s' % (rder_front1, order_behind1))
        ...
        do2.__next__()
        du.place_an_order(is_cash=True)
        try:
            do2.__next__()
        except StopIteration:
            pass
        ...
        print('下单前%s  下单后%s' % (rder_front2, order_behind2))
        # '''
        #     收藏
        # '''
        ...
        if is_success:
            du.place_an_order(is_cash=True, is_readdress=True)
